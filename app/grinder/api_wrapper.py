...
config.read('/usr/src/app/grinder/config.cfg')
...
def get_track_list(search_query, query_filter, limit=20, offset=0):
    '''
    ...
    search_query = 'jimi hendrix'


    response = sp.search(search_query, limit, offset, query_filter )
